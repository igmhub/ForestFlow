...
# %%
for axis in range(3):
    plt.plot(k_Mpc,central_z3[axis]['p1d_Mpc']/central_z3['total']['p1d_Mpc'],label=axis)
plt.xlim(0,3)
plt.legend()
...
total_p1d = 0.5*(central_mf**2 * central_z3['total']['p1d_Mpc'] + seed_mf**2 * seed_z3['total']['p1d_Mpc']) / total_mf**2

# %%
plt.plot(k_Mpc,central_z3['total']['p1d_Mpc']/total_p1d,label='central combined')
...
# %%
for axis in range(3):
    plt.plot(k_Mpc,central_z3[axis]['p1d_Mpc']/total_p1d,alpha=0.3,label='central '+str(axis))
    plt.plot(k_Mpc,seed_z3[axis]['p1d_Mpc']/total_p1d,alpha=0.3,label='seed '+str(axis))
